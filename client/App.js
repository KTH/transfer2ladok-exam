...
function App ({ courseId }) {
  ...
  const nextButton = (
    <input
      ...
      value='Show students and results →'
    ></input>
  )
  ...
  const content1 = (
    <div className='form-group'>
      ...
      <select
        className={
          selectedAssignment ? 'form-control ' : 'form-control required_input'
        }
      ...
      <select
        className={
          selectedModule ? 'form-control ' : 'form-control required_input'
        }
        name='ladok_module'
      ...
      <input
        ...
        className={
          examinationDate ? 'form-control ' : 'form-control required_input'
        }
        type='date'
      ...
      <div className='form-footer'>
        <input
          type='button'
          className='btn btn-warn form-footer-btn'
