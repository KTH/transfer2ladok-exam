...
async function getGrades (courseId, assignmentId, moduleId, token) {
  ...
  const ladokGrades = course.integration_id
    ? await ladok.listGradeableResults(course.integration_id, moduleId)
    : await ladok.listExamGradeableResults(
        '48855877-646e-11ea-bbe9-d6135c344c05'
      )
...
async function sendGradesToLadok (
  ...
  const gradeableResults = course.integration_id
    ? await ladok.listGradeableResults(course.integration_id, moduleId)
    : await ladok.listExamGradeableResults(
        '48855877-646e-11ea-bbe9-d6135c344c05'
      )
