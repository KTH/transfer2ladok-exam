...
module.exports = {
  /**
   * Send the grades in a assignment of a Canvas course to a module in Ladok
   *
   * - The assignment must have a grade compatible with the Ladok module
   * - The course must have an integration ID equal to the "KurstillfalleUID"
   *   in Ladok
   */
  async sendGradesToLadok (
    ...
    log.info(
      `From course ${courseId}, assignment ${assignmentId} to module ${ladokModuleId}`
    )
